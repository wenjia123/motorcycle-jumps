...
# Load data
data = loadtxt('jump_closeloop_suspension_data_PD.txt', delimiter=',')
data1 = loadtxt('jump_closeloop_suspension_data_PI.txt', delimiter=',')
data2 = loadtxt('openloop__suspension_webots_data.txt', delimiter=',')
...
plt.title('Comparison of Suspension compression For Different Control Strategies')
