...
# Load data
data = loadtxt('jump_closeloop_suspension_data_PI.txt', delimiter=',')
data1 = loadtxt('jump_closeloop_suspension_data_PD.txt', delimiter=',')
data2 = loadtxt('openloop_webots_data.txt', delimiter=',')
data3 = loadtxt('jump_closeloop_suspension_data_speedonly.txt', delimiter=',')
data4 = loadtxt('jump_closeloop_suspension_data_takeoffonly.txt', delimiter=',')
...
plt.title('Comparison of Pitch Angles(D=20m,R=10m,theta_t = 0.7 radians,theta_l = 0.349 radians)')
...
plt.title('Comparison of Suspension compression(D=20m,R=10m,theta_t = 0.7 radians,theta_l = 0.349 radians)')
plt.legend(loc='upper right')  # Move legend outside the plot if it's too crowded
plt.tight_layout()
plt.savefig('Suspension_compression.png')
plt.show()
